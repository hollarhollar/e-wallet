...
* Examples Page: Adds anchor tags to each example. For example, navigating to https://seiyria.com/bootstrap-slider/#example-10 will now load the page at Example #10.
