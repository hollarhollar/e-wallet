<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/MasterPage.master" AutoEventWireup="true" CodeFile="CollectionReportSearchByDate.aspx.cs" Inherits="Dashboard_CollectionReportSearchByDate" %>
    ...
    <div style="padding-left: 10px;">
        ...
        <asp:GridView ID="grd_collector" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="totalFunded" HeaderText="Total Fund" />
                <asp:BoundField DataField="totalTransAmount" HeaderText="Total Collection" />
                <asp:BoundField DataField="diffAmount" HeaderText="Balance" />
            </Columns>
