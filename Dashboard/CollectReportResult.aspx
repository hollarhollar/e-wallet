<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Dashboard/MasterPage.master"  CodeFile="CollectReportResult.aspx.cs" EnableEventValidation="false" UICulture="en-Ng" Culture="en-NG" Inherits="Dashboard_CollectReportResult" %>
    ...
    <div style="padding-left:10px">
        ...
        <asp:GridView ID="grd_collector" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="totalTransAmount"  DataFormatString="{0:C}"  HeaderText="(₦) Total Collection" HtmlEncode="false" />
