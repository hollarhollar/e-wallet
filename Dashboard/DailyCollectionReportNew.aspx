<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Dashboard/MasterPage.master" Culture="en-NG" UICulture="en-NG" EnableEventValidation="false" CodeFile="DailyCollectionReportNew.aspx.cs" Inherits="Dashboard_DailyCollectionReportNew" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-left: 10px">
        <table class="border" style="width: 100%">
            <tr>
                ...
                <td>
                    <div class='input-group date' id='datetimepicker8' style="width: 160px; margin-right: -50px;">
            ...
            <%--    <td style="width: 110px;">END DATE</td>
                <td>
                    <div class='input-group date' id='datetimepicker9' style="width: 160px; margin-right: -50px;">
    ...
    <asp:GridView ID="grd_collector" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Total Collection" DataFormatString="{0:C}" HtmlEncode="false" HeaderText="(₦) Total Collection" />
