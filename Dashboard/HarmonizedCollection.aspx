<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/MasterPageTwo.master" Culture="en-NG" UICulture="en-NG" AutoEventWireup="true" EnableEventValidation="false" CodeFile="HarmonizedCollection.aspx.cs" Inherits="Dashboard_HarmonizedCollection" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box-header with-border">
        <h3 class="box-title">Harmonized Buses and Taxi</h3>
    </div>
    <div style="padding-left: 10px;">
        <table class="table borderless" style="width: 100% !important; border: none !important;">
            <tr>
                ...
                <td><asp:DropDownList runat="server" AppendDataBoundItems="true" ID="types" CssClass="form-control" AutoPostBack="true"  style="width: 160px; margin-right: -50px;" Visible="true">
                    <asp:ListItem Text="All" Value="('40', '43')"></asp:ListItem>
        ...
        <asp:GridView ID="grd_collector" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="RTEAN" DataFormatString="{0:C}" HtmlEncode="false" HeaderText="(₦) RTEAN" />
                <asp:BoundField DataField="NURTW" DataFormatString="{0:C}" HtmlEncode="false" HeaderText="(₦) NURTW" />
