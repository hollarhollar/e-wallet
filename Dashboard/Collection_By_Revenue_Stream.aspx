<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/MasterPage.master" AutoEventWireup="true" CodeFile="Collection_By_Revenue_Stream.aspx.cs" Inherits="Dashboard_Collection_By_Revenue_Stream" %>
...
<asp:Button runat="server" CssClass="btn btn-primary" Text="Search" ID="btnSearch" OnClick="btnSearch_Click"/>
        ...
        CssClass="GridBaseStyle" HeaderStyle-CssClass="GridHeader" OnPageIndexChanging="grd_trans_history_PageIndexChanging" OnSelectedIndexChanging="grd_trans_history_SelectedIndexChanging">
